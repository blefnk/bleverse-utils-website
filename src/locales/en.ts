...
const dictionary = {
  ...
  pages: {
    ...
    home: {
      title:
        "A collection of the best {tools} for React, Next.js, and more. Just for you.",
      subtitle:
        "Bleverse Utils is a collection of free online utils. We have 100+ utils to help you in your web daily life.",
