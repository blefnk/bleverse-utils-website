...
const dictionary = {
  ...
  pages: {
    ...
    home: {
      ...
      subtitle:
        "Bleverse Utils é uma coleção de ferramentas online gratuitas. Temos mais de 100 ferramentas para ajudá-lo em sua rotina.",
      ...
      "open-source": {
        ...
        subtitle: {
          first:
            "Bleverse Utils é um projeto de código aberto e apoia projetos de código aberto.",
    ...
    about: {
      title: "Sobre",
      subtitle:
        "Bleverse Utils é uma coleção de ferramentas online gratuitas. Temos mais de 100 ferramentas para ajudá-lo em sua vida diária. Este projeto é de código aberto e você pode contribuir com ele {link}.",
