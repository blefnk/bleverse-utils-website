...
const dictionary = {
  ...
  pages: {
    ...
    home: {
      title:
        "Discover the paramount {tools} for Next.js, React, and beyond. Tailored especially for you.",
      subtitle:
        "Bleverse Utils simplifies your development journey. Start with built-in features optimized for modern web development.",
      "get-started": "Get Started",
      features: {
        title: "Features",
        subtitle:
          "This project has a lot of features that will help you in your web daily life.",
        cryptography: {
          title: "Cryptography",
      ...
      "open-source": {
        ...
        subtitle: {
          first:
            "Bleverse Utils is an open source project and it supports open source projects.",
    ...
    about: {
      title: "About",
      subtitle:
        "Bleverse Utils is a collection of free online tools. We have 100+ tools to help you in your web daily life. This project is open source and you can contribute to it by {link}.",
